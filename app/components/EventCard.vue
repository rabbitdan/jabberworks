  ...
  >
    <div>
      ...
      <dl class="mt-4 grid grid-cols-12 gap-4">
        <div class="grid col-span-12 md:col-span-3 p-2 border-b-4 border-dashed border-jw_red">
        ...
        <div v-if="eventTime" class="grid col-span-12 md:col-span-3 p-2 border-b-4 border-dashed border-jw_red">
        ...
        <div v-if="eventLocation" class="grid col-span-12 md:col-span-3 p-2 border-b-4 border-dashed border-jw_red">
